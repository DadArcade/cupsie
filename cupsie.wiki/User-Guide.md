...
Access to certain printers and queues may depend on the username you entered in the Options:
* **How Cupsie identifies you**: Cupsie uses 'Chrome user' username by default, but you can change it in the Options.
